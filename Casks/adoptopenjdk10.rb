cask 'adoptopenjdk10' do
  ...
  url "https://github.com/AdoptOpenJDK/openjdk#{version.before_comma}-binaries/releses/download/jdk-#{version.before_comma}.#{version.after_comma.before_colon}%2B#{version.after_colon}/OpenJDK#{version.before_comma}U-jdk_x64_mac_jdk-#{version.before_comma}.#{version.after_comma.before_colon}_#{version.after_colon}.tar.gz"
