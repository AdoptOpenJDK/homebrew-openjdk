cask 'adoptopenjdk11-openj9' do
  ...
  url "https://github.com/AdoptOpenJDK/openjdk11-binaries/releases/download/jdk-#{version.before_comma}%2B#{version.after_comma}/OpenJDK11U-jdk_x64_mac_openj9-0.12.1_jdk-#{version.before_comma}_#{version.after_comma}_openj9-0.12.1_#{version.before_comma}_#{version.after_comma}.tar.gz"
